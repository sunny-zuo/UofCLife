package {
	...
	public class AchievementFront extends MovieClip {
		...
		private function updateEDCInfo(): void {
			...
			//Holder Two
			if (firstAchievementToDisplay + 1 < achievementHandler.achievementData.data.edc.length) {
				...
				this.achievementHolderTwo.completeStatus.gotoAndStop(3); //blank box
			}

			//Holder Three
			if (firstAchievementToDisplay + 2 < achievementHandler.achievementData.data.edc.length) {
				...
				this.achievementHolderThree.achievementName.text = "";
				this.achievementHolderThree.achievementDescription.text = "";
				this.achievementHolderThree.completeStatus.gotoAndStop(3);
			}
		}
