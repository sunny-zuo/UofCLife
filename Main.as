package {
	...
	public class Main extends MovieClip {
		...
		private function start(): void {
			...
			tempStranger = new Stranger(1550, 0, ["Geography is for nerds like me!", "I dare thee to a geography duel!", [MenuController.generateDecisionBox, "fcn_generateQuiz", [10, "Geography", "hard", 10, "multiple", 70], "fcn_skipToSayDialog", [3], tempStranger], "Fight me scrub", ["fcn_skipToSayDialog", -1]]);
